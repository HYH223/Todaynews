   ...
   $con = mysqli_connect("localhost", "todaynews", "coding1998!", "todaynews");
    ...
    if ($result) {
        while ($row=mysqli_fetch_array($result)) {
            array_push($data,array('Keyword_Word'=>$row[0],'Emotion'=>$row[1]));
        }
